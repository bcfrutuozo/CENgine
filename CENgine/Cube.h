...
{
public:
	static IndexedTriangleList Make( std::optional<CENgineexp::VertexLayout> layout = {} )
	{
		using Type = CENgineexp::VertexLayout::ElementType;
		...
		CENgineexp::VertexBuffer vertices( std::move( *layout ),8u );
	...
	static IndexedTriangleList MakeIndependent( CENgineexp::VertexLayout layout )
	{
		using Type = CENgineexp::VertexLayout::ElementType;

		constexpr float side = 1.0f / 2.0f;

		CENgineexp::VertexBuffer vertices( std::move( layout ),24u );
	...
	static IndexedTriangleList MakeIndependentTextured()
	{
		...
		auto itl = MakeIndependent( std::move( CENgineexp::VertexLayout{}
