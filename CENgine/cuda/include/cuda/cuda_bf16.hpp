...
/* Member functions only available to nvcc compilation so far */
    ...
    __device__ __nv_bfloat16(short val) { __x = __short2bfloat16_rn(val).__x;  }
    __device__ __nv_bfloat16(unsigned short val) { __x = __ushort2bfloat16_rn(val).__x;  }
    __device__ __nv_bfloat16(int val) { __x = __int2bfloat16_rn(val).__x;  }
    __device__ __nv_bfloat16(unsigned int val) { __x = __uint2bfloat16_rn(val).__x;  }
    __device__ __nv_bfloat16(long long val) { __x = __ll2bfloat16_rn(val).__x;  }
    __device__ __nv_bfloat16(unsigned long long val) { __x = __ull2bfloat16_rn(val).__x; }

    /* Allow automatic casts to supported builtin types, matching all that are permitted with float */
    __device__ operator short() const { return __bfloat162short_rz(*this); }
    __device__ __nv_bfloat16 &operator=(short val) { __x = __short2bfloat16_rn(val).__x; return *this; }

    __device__ operator unsigned short() const { return __bfloat162ushort_rz(*this); }
    __device__ __nv_bfloat16 &operator=(unsigned short val) { __x = __ushort2bfloat16_rn(val).__x; return *this; }

    __device__ operator int() const { return __bfloat162int_rz(*this); }
    __device__ __nv_bfloat16 &operator=(int val) { __x = __int2bfloat16_rn(val).__x; return *this; }

    __device__ operator unsigned int() const { return __bfloat162uint_rz(*this); }
    __device__ __nv_bfloat16 &operator=(unsigned int val) { __x = __uint2bfloat16_rn(val).__x; return *this; }

    __device__ operator long long() const { return __bfloat162ll_rz(*this); }
    __device__ __nv_bfloat16 &operator=(long long val) { __x = __ll2bfloat16_rn(val).__x; return *this; }

    __device__ operator unsigned long long() const { return __bfloat162ull_rz(*this); }
    __device__ __nv_bfloat16 &operator=(unsigned long long val) { __x = __ull2bfloat16_rn(val).__x; return *this; }
...
public:
    ...
    __CUDA_HOSTDEVICE__ operator __nv_bfloat162_raw() const { __nv_bfloat162_raw ret; __BFLOAT162_TO_UI(ret) = __BFLOAT162_TO_CUI(*this); return ret; }
};
...
__CUDA_BF16_DECL__ int __bfloat162int_rz(__nv_bfloat16 h)
{
    return __float2int_rz(__bfloat162float(h));
}
...
__CUDA_BF16_DECL__ __nv_bfloat16 __int2bfloat16_rn(int i)
{
...
__CUDA_BF16_DECL__ short int __bfloat162short_rz(__nv_bfloat16 h)
{
   short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_BF16_DECL__ __nv_bfloat16 __short2bfloat16_rn(short int i)
{
    float ru = __int2float_ru(static_cast<int>(i));
    float rd = __int2float_rd(static_cast<int>(i));
    float rz = __int2float_rz(static_cast<int>(i));
    if (ru != rd) {
        rz = __uint_as_float(__float_as_uint(rz) | 1U);
    }
    return __float2bfloat16_rn(rz);
...
__CUDA_BF16_DECL__ unsigned int __bfloat162uint_rz(__nv_bfloat16 h)
{
    return __float2uint_rz(__bfloat162float(h));
}
...
__CUDA_BF16_DECL__ __nv_bfloat16 __uint2bfloat16_rn(unsigned int i)
{
...
__CUDA_BF16_DECL__ unsigned short int __bfloat162ushort_rz(__nv_bfloat16 h)
{
   unsigned short int val;
   asm("{ .reg.f32 f;\n"
       "  mov.b32 f, {0,%1};\n"
...
__CUDA_BF16_DECL__ __nv_bfloat16 __ushort2bfloat16_rn(unsigned short int i)
{
    float ru = __uint2float_ru(static_cast<unsigned int>(i));
    float rd = __uint2float_rd(static_cast<unsigned int>(i));
    float rz = __uint2float_rz(static_cast<unsigned int>(i));
    if (ru != rd) {
        rz = __uint_as_float(__float_as_uint(rz) | 1U);
    }
    return __float2bfloat16_rn(rz);
...
__CUDA_BF16_DECL__ unsigned long long int __bfloat162ull_rz(__nv_bfloat16 h)
{
    return __float2ull_rz(__bfloat162float(h));
}
...
__CUDA_BF16_DECL__ __nv_bfloat16 __ull2bfloat16_rn(unsigned long long int i)
{
...
__CUDA_BF16_DECL__ long long int __bfloat162ll_rz(__nv_bfloat16 h)
{
    return __float2ll_rz(__bfloat162float(h));
}
...
__CUDA_BF16_DECL__ __nv_bfloat16 __ll2bfloat16_rn(long long int i)
{
...
__CUDA_BF16_DECL__ __nv_bfloat162 atomicAdd(__nv_bfloat162 *address, __nv_bfloat162 val)
{
    ...
    do {
        assumed = old;
        __nv_bfloat162 new_val = val + *(__nv_bfloat162*)&assumed;
...
__CUDA_BF16_DECL__ __nv_bfloat16 atomicAdd(__nv_bfloat16 *address, __nv_bfloat16 val)
{
    ...
    do {
        ...
        old = atomicCAS(address_as_us, assumed,
            __bfloat16_as_ushort(val + __ushort_as_bfloat16(assumed)));
    } while (assumed != old);
