...
#define DMI_TYPE_CACHE_INFORMATION				7
#define DMI_TYPE_SYSSLOT						9
#define DMI_TYPE_PHYSICAL_MEMORY_ARRAY			16
#define DMI_TYPE_MEMORY_DEVICE					17
#define DMI_TYPE_MEMORY_ARRAY_MAPPED_ADDRESS	19
#define DMI_TYPE_SYSTEM_BOOT_INFORMATION		32
...
public:
	SMBIOS();
	const TypeMemoryDevice GetPhysicalMemory(const int p_Index);
	const TypePhysicalMemory GetPhysicalMemoryArray();
